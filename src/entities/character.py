...
class Character():
    ...
    def __init__(self, id=None, gender=None, life_stage=None, voice=None, aspiration=None,
            ...
            self.life_stage = life_stage if life_stage else random.choice(self.life_stages)
            self.voice = voice if voice else random.choice(self.voices)
            self.aspiration = aspiration if aspiration else random.choice(self.aspirations)
            self.skin_tone = skin_tone if skin_tone else random.choice(self.skin_tones)
            self.hair_style = hair_style if hair_style else random.choice(self.hair_styles)
            self.hair_color = hair_color if hair_color else random.choice(self.hair_colors)
            self.eye_color = eye_color if eye_color else random.choice(self.eye_colors)
